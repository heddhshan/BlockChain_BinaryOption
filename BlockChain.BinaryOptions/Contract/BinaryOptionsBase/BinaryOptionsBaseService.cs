...
using BlockChain.BinaryOptions.Contract.BinaryOptionsBase.ContractDefinition;

namespace BlockChain.BinaryOptions.Contract.BinaryOptionsBase
{
    public partial class BinaryOptionsBaseService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BinaryOptionsBaseDeployment binaryOptionsBaseDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BinaryOptionsBaseDeployment>().SendRequestAndWaitForReceiptAsync(binaryOptionsBaseDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BinaryOptionsBaseDeployment binaryOptionsBaseDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BinaryOptionsBaseDeployment>().SendRequestAsync(binaryOptionsBaseDeployment);
        }

        public static async Task<BinaryOptionsBaseService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BinaryOptionsBaseDeployment binaryOptionsBaseDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, binaryOptionsBaseDeployment, cancellationTokenSource);
            return new BinaryOptionsBaseService(web3, receipt.ContractAddress);
        }
        ...
        public BinaryOptionsBaseService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public BinaryOptionsBaseService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
