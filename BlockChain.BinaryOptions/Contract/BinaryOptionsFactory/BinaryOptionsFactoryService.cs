...
using BlockChain.BinaryOptions.Contract.BinaryOptionsFactory.ContractDefinition;

namespace BlockChain.BinaryOptions.Contract.BinaryOptionsFactory
{
    public partial class BinaryOptionsFactoryService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BinaryOptionsFactoryDeployment binaryOptionsFactoryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BinaryOptionsFactoryDeployment>().SendRequestAndWaitForReceiptAsync(binaryOptionsFactoryDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BinaryOptionsFactoryDeployment binaryOptionsFactoryDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BinaryOptionsFactoryDeployment>().SendRequestAsync(binaryOptionsFactoryDeployment);
        }

        public static async Task<BinaryOptionsFactoryService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BinaryOptionsFactoryDeployment binaryOptionsFactoryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, binaryOptionsFactoryDeployment, cancellationTokenSource);
            return new BinaryOptionsFactoryService(web3, receipt.ContractAddress);
        }
        ...
        public BinaryOptionsFactoryService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public BinaryOptionsFactoryService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
        ...
        public Task<string> CreateRequestAsync(BigInteger roundPeriod)
        {
        ...
        public Task<TransactionReceipt> CreateRequestAndWaitForReceiptAsync(BigInteger roundPeriod, CancellationTokenSource cancellationToken = null)
        {
            var createFunction = new CreateFunction();
                createFunction.RoundPeriod = roundPeriod;
        ...
        public Task<string> RoundPeriodBoOfQueryAsync(BigInteger returnValue1, BlockParameter blockParameter = null)
        {
