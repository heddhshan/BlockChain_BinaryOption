...
using BlockChain.BinaryOptions.Contract.TokenA.ContractDefinition;

namespace BlockChain.BinaryOptions.Contract.TokenA
{
    public partial class TokenAService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TokenADeployment tokenADeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TokenADeployment>().SendRequestAndWaitForReceiptAsync(tokenADeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TokenADeployment tokenADeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TokenADeployment>().SendRequestAsync(tokenADeployment);
        }

        public static async Task<TokenAService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TokenADeployment tokenADeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, tokenADeployment, cancellationTokenSource);
            return new TokenAService(web3, receipt.ContractAddress);
        }
        ...
        public TokenAService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public TokenAService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
