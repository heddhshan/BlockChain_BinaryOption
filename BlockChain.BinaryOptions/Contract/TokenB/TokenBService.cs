...
using BlockChain.BinaryOptions.Contract.TokenB.ContractDefinition;

namespace BlockChain.BinaryOptions.Contract.TokenB
{
    public partial class TokenBService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TokenBDeployment tokenBDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TokenBDeployment>().SendRequestAndWaitForReceiptAsync(tokenBDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TokenBDeployment tokenBDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TokenBDeployment>().SendRequestAsync(tokenBDeployment);
        }

        public static async Task<TokenBService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TokenBDeployment tokenBDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, tokenBDeployment, cancellationTokenSource);
            return new TokenBService(web3, receipt.ContractAddress);
        }
        ...
        public TokenBService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public TokenBService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
