...
using BlockChain.BinaryOptions.Contract.BetToken.ContractDefinition;

namespace BlockChain.BinaryOptions.Contract.BetToken
{
    public partial class BetTokenService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BetTokenDeployment betTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BetTokenDeployment>().SendRequestAndWaitForReceiptAsync(betTokenDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BetTokenDeployment betTokenDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BetTokenDeployment>().SendRequestAsync(betTokenDeployment);
        }

        public static async Task<BetTokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BetTokenDeployment betTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, betTokenDeployment, cancellationTokenSource);
            return new BetTokenService(web3, receipt.ContractAddress);
        }
        ...
        public BetTokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public BetTokenService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
