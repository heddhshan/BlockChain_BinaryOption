...
using BlockChain.BinaryOptions.Contract.BinaryOptionsChainlink.ContractDefinition;

namespace BlockChain.BinaryOptions.Contract.BinaryOptionsChainlink
{
    public partial class BinaryOptionsChainlinkService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BinaryOptionsChainlinkDeployment binaryOptionsChainlinkDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BinaryOptionsChainlinkDeployment>().SendRequestAndWaitForReceiptAsync(binaryOptionsChainlinkDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BinaryOptionsChainlinkDeployment binaryOptionsChainlinkDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BinaryOptionsChainlinkDeployment>().SendRequestAsync(binaryOptionsChainlinkDeployment);
        }

        public static async Task<BinaryOptionsChainlinkService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BinaryOptionsChainlinkDeployment binaryOptionsChainlinkDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, binaryOptionsChainlinkDeployment, cancellationTokenSource);
            return new BinaryOptionsChainlinkService(web3, receipt.ContractAddress);
        }
        ...
        public BinaryOptionsChainlinkService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public BinaryOptionsChainlinkService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
        ...
        public Task<string> ChainlinkAggregatorQueryAsync(ChainlinkAggregatorFunction chainlinkAggregatorFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<ChainlinkAggregatorFunction, string>(chainlinkAggregatorFunction, blockParameter);
        }

        
        public Task<string> ChainlinkAggregatorQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<ChainlinkAggregatorFunction, string>(null, blockParameter);
        }
        ...
        public Task<GetFormartPriceOutputDTO> GetFormartPriceQueryAsync(BigInteger time, BlockParameter blockParameter = null)
        {
            var getFormartPriceFunction = new GetFormartPriceFunction();
                getFormartPriceFunction.Time = time;
        ...
        public Task<BigInteger> GetPriceQueryAsync(BigInteger time, BlockParameter blockParameter = null)
        {
            var getPriceFunction = new GetPriceFunction();
                getPriceFunction.Time = time;
