...
using BlockChain.BinaryOptions.Contract.PlayToken.ContractDefinition;

namespace BlockChain.BinaryOptions.Contract.PlayToken
{
    public partial class PlayTokenService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, PlayTokenDeployment playTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<PlayTokenDeployment>().SendRequestAndWaitForReceiptAsync(playTokenDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, PlayTokenDeployment playTokenDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<PlayTokenDeployment>().SendRequestAsync(playTokenDeployment);
        }

        public static async Task<PlayTokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, PlayTokenDeployment playTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, playTokenDeployment, cancellationTokenSource);
            return new PlayTokenService(web3, receipt.ContractAddress);
        }
        ...
        public PlayTokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public PlayTokenService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
