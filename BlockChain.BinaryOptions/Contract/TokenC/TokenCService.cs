...
using BlockChain.BinaryOptions.Contract.TokenC.ContractDefinition;

namespace BlockChain.BinaryOptions.Contract.TokenC
{
    public partial class TokenCService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TokenCDeployment tokenCDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TokenCDeployment>().SendRequestAndWaitForReceiptAsync(tokenCDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TokenCDeployment tokenCDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TokenCDeployment>().SendRequestAsync(tokenCDeployment);
        }

        public static async Task<TokenCService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TokenCDeployment tokenCDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, tokenCDeployment, cancellationTokenSource);
            return new TokenCService(web3, receipt.ContractAddress);
        }
        ...
        public TokenCService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public TokenCService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
