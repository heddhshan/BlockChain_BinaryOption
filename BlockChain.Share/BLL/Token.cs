...
namespace BlockChain.Share.BLL
{
    public class Token
    {
        ...
        public static bool IniTokenData(int chainId)
        {
            ...
            // eth
             SaveTokenData(chainId, ShareParam.AddressEth, @"TokenIcon\Eth.png", true);

            if (chainId == 1)
            {
                //token 初始化，还需要 usdt usdc busd  dai  wbtc stEth, wstEth， bnb 这几个token， https://etherscan.io/tokens
                 SaveTokenData(chainId, "0xdAC17F958D2ee523a2206206994597C13D831ec7", @"TokenIcon\Usdt.png", true);              //usdt https://etherscan.io/token/0xdac17f958d2ee523a2206206994597c13d831ec7
                 SaveTokenData(chainId, "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", @"TokenIcon\USDC.png", true);              //usdc https://etherscan.io/token/0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48
                //await SaveTokenData(chainId, "0x4Fabb145d64652a948d72533023f6E7A623C7C53", @"TokenIcon\binanceusd_32.png", true);     //busd https://etherscan.io/token/0x4fabb145d64652a948d72533023f6e7a623c7c53
                 SaveTokenData(chainId, "0x6B175474E89094C44Da98b954EedeAC495271d0F", @"TokenIcon\dai_stablecoin.png", true);    //dai  https://etherscan.io/token/0x6b175474e89094c44da98b954eedeac495271d0f

                 SaveTokenData(chainId, "0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599", @"TokenIcon\wbtc28.png", true);            //wbtc https://etherscan.io/token/0x2260fac5e5542a773aa44fbcfedf7c193bc2c599

                 SaveTokenData(chainId, "0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84", @"TokenIcon\stETH28.png", true);           //stEth https://etherscan.io/token/0xae7ab96520de3a18e5e111b5eaab095312d7fe84
                 SaveTokenData(chainId, "0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0", @"TokenIcon\wstETH.png", true);            //wstEth https://etherscan.io/token/0x7f39c581f595b53c5cb19bd0b3f8da6c935e2ca0
            ...
            {
                 SaveTokenData(chainId, ShareParam.AddressPricingToken, @"TokenIcon\NoJPG.png", true);
            }
        ...
        public static bool SaveTokenData(string TokenAddress, string ImagePath, bool FromUser = true, bool isFixedPrice = false, string priceToken = "", decimal price = 0)
        {
            var ChainId = (int)ShareParam.GetChainId();
            return SaveTokenData(ChainId, TokenAddress, ImagePath, FromUser, isFixedPrice, priceToken, price);
        }

        public static bool SaveTokenData(int ChainId, string TokenAddress, string ImagePath, bool FromUser = true, bool isFixedPrice = false, string priceToken = "", decimal price = 0)
        {
        ...
        public static Model.Token GetModel(string tokenAddress)
        {
            ...
            if (result == null)
            {
                ...
                if (result == null)
                {
                    var CallResult = SaveNewToken(tokenAddress);                                 //这个自动保存的做法，是否合理！！！  存在的问题是没用图标，这个也可以忍受！
        ...
        private static bool SaveNewToken(string tokenAddress)
        {
