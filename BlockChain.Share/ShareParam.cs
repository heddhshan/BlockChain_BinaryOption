...
namespace BlockChain.Share
{
    ...
    public static class ShareParam
    {
        ...
        public static int FromBlock
        {
            get
            {
                return 10148000;            //todo: test   不同程序使用时候需要修改，这个 10148000 满足 2023年12月发布的 goerli 网络的合约！！！！
        ...
        public const int MaxBlock = 50000;          //5_000_000;   // 2023-10-26 有的rpc接口有限制，这个数据可能要做成参数！！！！      //币安，5000; 以太坊，可以不要; 采用比最大值小点的数据 
        ...
        { 
            ...
            string key = token + "{7A1D56B4-E751-441F-A21E-12D3981DF43D}";
            var result = Common.Cache.GetData(key);
            if (result == null)
            {
                result = _Erc20ApproveMaxValue(token);
        ...
        /// </summary>
        private static System.Numerics.BigInteger _Erc20ApproveMaxValue(string token)
        {
        ...
        //public static readonly System.Numerics.BigInteger Const_Erc20ApproveMaxValue = System.Numerics.BigInteger.Parse("115792089237316195423570985008687907853269984665640564039451477818518257417236");
